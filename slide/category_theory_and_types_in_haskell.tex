...
\frame{
  ...
  \centerline{
    \xymatrix@=60pt{
      \code{[Integer]} \ar[r]^{\code{fmap show}} \ar[d]^{\code{takeFirst}} & \code{[String]} \ar[d]^{\code{takeFirst}} \\
      \code{Maybe Integer} \ar[r]^{\code{fmap show}} & \code{Maybe String}
    }
  }
}
...
\frame{
  ...
  \centerline{
    \xymatrix@=60pt{
      \code{[1, 2, 3]} \ar@{|->}[r]^{\code{fmap show}} \ar@{|->}[d]^{\code{takeFirst}} & \code{["1","2","3"]} \ar@{|->}[d]^{\code{takeFirst}} \\
      \code{Just 1} \ar@{|->}[r]^{\code{fmap show}} & \code{Just "1"}
    }
  }
  \centerline{
    \xymatrix@=60pt{
      \code{[]} \ar@{|->}[r]^{\code{fmap show}} \ar@{|->}[d]^{\code{takeFirst}} & \code{[]} \ar@{|->}[d]^{\code{takeFirst}} \\
      \code{Nothing} \ar@{|->}[r]^{\code{fmap show}} & \code{Nothing}
    }
  }
}
